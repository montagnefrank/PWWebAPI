...
<div class="page-title">                    
    <h2><span class="fa fa-list-ol"></span> Encuestas de los usuarios</h2>
</div> 
            ...
            <div class="panel panel-default">
                <div class="panel-heading mail">
                    <div class="mail-item mail-primary">          
                        ...
                        <a href="#" class="mail-text readmessage_btn">Email</a>                                    
        ...
        <div class="col-md-12 readmessage_panel hidethis">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <h3><span class="readmsgPhone">Re: Product development</span> <small class="pull-right text-muted readmsgTime"></small></h3>
                    <p class="readmsgMsg"></p>
                    <label>Direccion</label>
                    <p class="readmsgAddr"></p>
                    <label>Ciudad</label>
                    <p class="readmsgCity"></p>
                    <label>Provincia</label>
                    <p class="readmsgEdo"></p>
                    <label>Detalles</label>
                    <p class="readmsgDet"></p>
                    <label>Nombre del Proyecto</label>
                    <p class="readmsgProname"></p>
                    <label>Modelo</label>
                    <p class="readmsgTipo"></p>
                    <label>Linea de tiempo</label>
                    <p class="readmsgTimeline"></p>
                    <label>Presupuesto</label>
                    <p class="readmsgPres"></p>
                    <label>Uso Funcional</label>
                    <p class="readmsgUso"></p>
                    <label>Zona de Riesgo</label>
                    <p class="readmsgZona"></p>
                    <label>Calefaccion, Ventilacion, Aire acondicionado</label>
                    <p class="readmsgSpecs"></p>
                    <label>Tipo de fundacion</label>
                    <p class="readmsgFund"></p>
                    <label>Sotano</label>
                    <p class="readmsgSota"></p>
                    <label>Acabados y Estilos</label>
                    <p class="readmsgEst"></p>
                    <label>Camion</label>
                    <p class="readmsgCami"></p>
                    <label>Comentarios</label>
                    <p class="readmsgCom"></p>
                </div>
            </div>
        </div>
    </div>
